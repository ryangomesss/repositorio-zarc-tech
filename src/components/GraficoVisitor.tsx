...
export default function GraficoVisitor() {
  return (
    ...
    <div className="grafico-container bg-white w-full rounded-md shadow-md flex flex-col items-center justify-center">
      ...
      <ChartContainer config={chartConfig} className="h-[200px] w-full p-3">
        <BarChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
          <CartesianGrid vertical={false} horizontal={true} strokeDasharray="4 4" stroke="#0000FF"  strokeWidth={0.2}/>
          ...
          <YAxis tickLine={false} axisLine={false} ticks={[0, 100, 200, 300, 400]} domain={[0, 400]} />
